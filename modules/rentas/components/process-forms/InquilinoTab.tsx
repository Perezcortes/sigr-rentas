        ...
        {editable && (
          <div className="pt-2 flex items-center gap-2">
            ...
            <Button
              ...
              onClick={() => {
                try {
                  // Intentar obtener id desde value o URL actual
                  const id = (value && (value.id || value.rentaId)) || undefined
                  const base = id ? `/rentas/${id}/inquilino-form` : `/rentas/0/inquilino-form`
                  window.open(base, "_blank")
                } catch {
                  window.open(`/rentas/0/inquilino-form`, "_blank")
                }
              }}
            >
